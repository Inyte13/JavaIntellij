...
public class Empleado extends Persona implements SubmenuPersona {
  ...
  public static Empleado crearEmpleado(Persona creador, String nombre, String apellido, String dni, String direccion, String nroTelefono, String correo, TipoCargo cargo,String contrasena){
