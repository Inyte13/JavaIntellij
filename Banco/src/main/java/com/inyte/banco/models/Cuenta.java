...
public class Cuenta implements SubmenuCuenta {
  ...
  public static Cuenta crearCuenta(Persona creador,TipoCuenta tipoCuenta){
    return new Cuenta(creador,tipoCuenta);
  }

  public static Cuenta crearCuenta(Persona creador,TipoCuenta tipoCuenta, double saldo){
